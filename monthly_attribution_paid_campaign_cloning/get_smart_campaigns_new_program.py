#input variables to Monthly Attribution Paid Campaign Cloning Step 9: Get Smart Campaigns New Program
input={
  'token': 'Token', #from Step 3: Get Token
  'program_id': 'Program ID' #from Step 8: Get New Program ID
  }
