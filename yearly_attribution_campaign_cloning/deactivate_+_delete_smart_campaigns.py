#input variables to Yearly Attribution Campaign Cloning Step 12: Deactivate + Delete Smart Campaigns
input={
  'token': 'Token', #from Step 3: Get Token
  'sc_ids': 'sc_ids', #from Step 11: Get Smart Campaigns Old Program
  'sc_names': 'sc_names' #from Step 11: Get Smart Campaigns Old Program
  }
