y#input variables to Monthly Attribution Campaign Cloning Step 4: Get Lv2 Folder or Create Lv2 Folder
input={
  'token': 'Token', #from Step 3: Get Token
  'clone' : 'Yearly Programs', #from Step 2: Lookup Program Names
...
match = re.search('\d*[\s\-\s]*(\w*\s\w*)\s-', clone[i]).group(1)
