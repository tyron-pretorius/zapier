...
#use the Marketo REST API leads endpoint to update a lead field's with the values contained within the input lead_dict_list
#https://developers.marketo.com/rest-api/lead-database/leads/#create_and_update
def createUpdateLead(base_url, token, lead_dict_list):
...
response = createUpdateLead(input['base_url'], input['token'], [final_dict])
log = "Update Response:\n" + response + "\n\n"
