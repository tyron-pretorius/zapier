#input variables to Zapier Step 3: Parse Owners and Prepare Slack Message
input={
  'text': 'text', #from Step 1: Start a Sub-Zap
  'f_names': 'f_names string', #from Step 2: Get First Names and Slack Names
  't_names': 't_names string' #from Step 2: Get First Names and Slack Names
  }
