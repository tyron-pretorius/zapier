function setValues() {
  ...
  var cost_values = sheet.getRange("C2:C"+lastRow).getValues();
  var program_values = sheet.getRange("D2:D"+lastRow).getValues();
  ...
  var submissions = SpreadsheetApp.getActiveSpreadsheet().getSheetByName("Cost Submissions");
