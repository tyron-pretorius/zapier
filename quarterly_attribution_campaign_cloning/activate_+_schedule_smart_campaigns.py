#input variables to Monthly Attribution Campaign Cloning Step 11:  Activate + Schedule Smart Campaigns
input={
  'token': 'Token', #from Step 3: Get Token
  'sc_ids': 'sc_ids', #from Step 10: Get Smart Campaigns New Program
  'sc_names': 'sc_names' #from Step 10: Get Smart Campaigns New Program
  }
...
for i in range(0,len(sc_ids)):
        if "Anonymous" not in sc_names[i]:
            ...
            day = str(calendar.monthrange(now.year,now.month+2)[1])
