#input variables to Monthly Attribution Campaign Cloning Step 5: Get Lv3 Folder or Create Lv3 Folder
input={
...
name = input['year'] + ' Quarterly ' + lvl1_info[1]
